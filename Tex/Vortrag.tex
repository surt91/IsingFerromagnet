...
\section{Model}
            ...
            \begin{columns}[t]
                ...
                \begin{column}{6cm}
                    \visible<2->{
                        ...
                        \begin{figure}[htbp]
                            \centering
                            \includegraphics[width=\textwidth]{images/Displacement}
                            \caption
                            {
    ...
    \subsection{Proximity Graphs}
        ...
        \begin{frame}{Delaunay Triangulation}
            \begin{figure}[htbp]
                \centering
                \includegraphics[width=\textwidth]{images/DT_def}
                \caption
                {
                    Example of a DT.
                }
        ...
        \begin{frame}{Gabriel Graph}
            \begin{columns}[b]
                \begin{column}{5cm}
                    \begin{figure}[htbp]
                        \centering
                        \includegraphics[width=\textwidth]{images/GG_def}
                        \caption
                        {
                            Lune of a GG.
                        }
        ...
        \begin{frame}{Relative Neighborhood Graph}
            \begin{columns}[b]
                \begin{column}{5cm}
                    \begin{figure}[htbp]
                        \centering
                        \includegraphics[width=\textwidth]{images/RNG_def}
                        \caption
                        {
                            Lune of a RNG.
                        }
                    ...
                    \begin{overprint}
                        \onslide<6>{
                            \only<6>{
                                \begin{figure}[htbp]
                                    \centering
                                    \includegraphics[width=\textwidth]{images/CellBig}
                                \end{figure}
                            }
                        }
                        \onslide<7>{
                                \begin{figure}[htbp]
                                    \centering
                                    \includegraphics[width=\textwidth]{images/CellSmall}
                                \end{figure}
                        }
                    \end{overprint}
                \end{column}
        ...
        \begin{frame}{Parallel Tempering \cite{ParallelTempering1986}}
            ...
            \begin{columns}[b]
                \begin{column}{5cm}
                    \begin{figure}[htbp]
                        \centering
                        \includegraphics[width=\textwidth]{images/parTempSchema}
                        \caption
                        {
                ...
                \begin{column}{6cm}
                    \begin{figure}[htbp]
                        \centering
                        \includegraphics[width=\textwidth]{images/parTempE}
                        \caption
                        {
            ...
            \begin{figure}[htbp]
                ...
                \resizebox{0.9\textwidth}{!}{
                    \subfigure{
                        ...
                        \includegraphics[width=\textwidth]{images/GGEdgeBefore}
                    }
                    \subfigure{
                        \label{sfig:GGEdge:after}
                        \includegraphics[width=\textwidth]{images/GGEdgeAfter}
                    }
                }
                \caption
                {
        ...
        \begin{frame}{Influence of the degree on \(T_{c}\)}
            \begin{columns}[b]
                \begin{column}{0.7\textwidth}
                    \begin{figure}[htb]
                        \centering
                        \includegraphics[width=\textwidth]{plots/Tc_K}
                        \caption
                        {
