...
set label 1 sprintf("{/Symbol g/n} = %.3f(1)", b1) at graph 0.25,0.50 left rotate by 30

fit f2(x) "data/GGSusceptibility_Max_s_0.3.dat" u 1:2:3 via a2,b2
set label 2 sprintf("{/Symbol g/n} = %.3f(4)", b2) at graph 0.45,0.30 left rotate by 30
