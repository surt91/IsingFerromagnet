...
plot "< paste data/GG_Tc.dat data/GG_sumJ_L32.dat" u 1:($2/$5):($3/$5+$2/$5**2*$6) w ye ps 2 pt 4 title "{/Italic T_c / {/Symbol \341}{/Symbol S}_{{/Symbol \341}i,j{/Symbol \361}} J_{ij}{/Symbol \361}}",\
