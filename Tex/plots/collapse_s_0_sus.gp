...
p "data/ScalanaSusceptibility_S_0.00_L_32.dat"  u (sx($1,32)):(sy($2,32)):(sy($3,32))  w ye lc 2 ps 2 pt 6 t "{/Italic L} = 32" \
, "data/ScalanaSusceptibility_S_0.00_L_64.dat"  u (sx($1,64)):(sy($2,64)):(sy($3,64))  w ye lc 3 ps 2 pt 8 t "{/Italic L} = 64" \
, "data/ScalanaSusceptibility_S_0.00_L_128.dat"  u (sx($1,128)):(sy($2,128)):(sy($3,128))  w ye lc 4 ps 2 pt 10 t "{/Italic L} = 128"
