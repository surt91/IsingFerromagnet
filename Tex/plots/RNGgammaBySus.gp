...
set label 1 sprintf("{/Symbol g/n} = %.3f(7)", b1) at graph 0.45,0.35 left rotate by 30
set label 2 sprintf("{/Symbol g/n} = %.3f(8)", b2) at graph 0.25,0.6 left rotate by 30
...
plot "data/RNGSusceptibility_Max_s_1.0.dat" u 1:2:3 w ye pt 6 ps 2 lc 3 t "{/Italic {/Symbol c}}_{max} at {/Symbol s} = 1.0", f2(x) lt 3 lc 3 notitle, \
     "data/RNGSusceptibility_Max_s_0.0.dat" u 1:2:3 w ye pt 4 ps 2 lc 1 t "{/Italic {/Symbol c}}_{max} at {/Symbol s} = 0.0", f1(x) lt 3 lc 1 notitle
