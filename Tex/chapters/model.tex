...
\label{ssec:isingmodel}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics{images/Displacement}
...
\label{ssec:graphtypes}
    ...
    \begin{figure}[htbp]
        ...
        \subfigure[Definition of the Lunes][]{
            ...
            \includegraphics{images/GG_RNG_def}
        }
    ...
    \subsubsection{Construction}
        ...
        \begin{figure}[htbp]
            ...
            \subfigure[not Connected Nodes][]{
                \label{sfig:cell:big}
                \includegraphics{images/CellBig}
            }
            \subfigure[Connected Nodes][]{
                \label{sfig:cell:small}
                \includegraphics{images/CellSmall}
            }
