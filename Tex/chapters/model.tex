...
\label{ssec:finitesize}
    ...
    \end{figure}\\
    But it is also visible, that there occurs no real jump, but a continuous
    ...
    trasition. This is stronger for smaller system sizes, as showed in
    fig. \ref{fig:smeared_out}\subref{sfig:smeared_out:meanM}.\\
