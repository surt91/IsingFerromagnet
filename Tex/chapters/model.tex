...
\label{sec:graphtypes}
    ...
    \begin{figure}[htbp]
        ...
        \subfigure{\includegraphics[width=0.3\textwidth]{images/GG/L12S03.pdf}}
        \subfigure{\includegraphics[width=0.3\textwidth]{images/RNG/L12S03.pdf}}
...
\subsection{Critical Temperature $T_c$ and Critical Exponents}
    ...
    \begin{figure}[htbp]
        \centering
        \subfigure{\includegraphics[width=0.3\textwidth]{images/binder_fit_s_0}}
