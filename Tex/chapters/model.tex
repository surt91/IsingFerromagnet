...
\label{ssec:isingmodel}
    ...
    First, let us define the Ising model and then explain the modifications.
    ...
    \begin{equation}
        H = \sum_{\avg{i,j}}J_{ij}s_{i}s_{j} - \tilde{H} \sum_i s_i
    ...
    \(\tilde{H}\) denotes the outer magnetic field.\\
    In this thesis \(\tilde{H}=0\). The most important modification is, that
