...
\subsection{Determining the Critical Temperature $T_c$}
    ...
    exponents [weiter ausarbeiten] [sagen, dass man für zwei/drei sigma
    ...
    \(G\) \cite{Binder1981} for different system sizes \(L=\sqrt N\).\\
