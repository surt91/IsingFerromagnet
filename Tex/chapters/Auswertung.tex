...
%~
    ...
    \begin{figure}[htbp]
        \centering
        \subfigure{\includegraphics[width=0.5\textwidth]{images/GG/plot_Tc}}
        \subfigure{\includegraphics[width=0.5\textwidth]{images/RNG/plot_Tc}}

        \subfigure{\includegraphics[width=0.5\textwidth]{images/GG/plot_deg}}
        \subfigure{\includegraphics[width=0.5\textwidth]{images/RNG/plot_deg}}
