...
\subsection{Equilibration- and Autocorrelation Time}
    ...
    \begin{figure}[htbp]
        ...
        \subfigure[Example of an equilibrating Ising system][]{
                ...
                \includegraphics[width=0.45\textwidth]{plots/equiE}
        }
        \subfigure[Example of the autocorrelation of an Ising system][]{
                \label{sfig:equiandauto:autoM}
                \includegraphics[width=0.45\textwidth]{plots/autoM}
        }
    ...
    \(\frac{\chi(t)}{\chi(0)}\) like in fig. \ref{fig:equiandauto}\subref{sfig:equiandauto:autoM}
