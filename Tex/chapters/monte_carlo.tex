...
But it is difficult to create random state of a physical system i.e. the
...
\label{ssec:eqtime}
    ...
    temperatures, where less spins are flipping. In this thesis always
    the longest autocorrelation time \(\tau\) of all simulated
    temperatures was taken.
    \[\tau = \max_T \tau_T\]
