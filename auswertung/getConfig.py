...
def getConfig():
    ...
    ####################################################################
    # GG:
    t16l=",".join([str(i) for i in arange(0.1,2.0,0.15)]+[str(i) for i in arange(2.0,2.4,0.2)]+[str(i) for i in arange(2.4,3.0,0.02)]+[str(i) for i in arange(3.0,3.3,0.2)])
    ...
    t32l=",".join([str(i) for i in arange(0.1,0.9,0.14)]+[str(i) for i in arange(0.9,2.4,0.09)]+[str(i) for i in arange(2.4,3.0,0.02)]+[str(i) for i in arange(3.0,3.3,0.2)])
